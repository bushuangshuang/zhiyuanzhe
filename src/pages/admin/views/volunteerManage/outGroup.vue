<template>
  <div>     
    <Tabs type="card">
            ...
            <TabPane label="脱落"  @click="enter(name)">
               <div class="topBody">
                <Form :model="health">
                <Row>
                    <Col span="6">
                    ...
                    <Col span="5">
                        <FormItem  class="mleft"  >
                          <Button type="primary" @click="search2"  style="margin-right:20px">查询</Button>
                          <Button @click="empty" style="margin-left:2px;margin-right:2px">清空</Button>                          
                        </FormItem>
                    </Col>
                </Row>
                          ...
                          <div class="tableText">                   
                        <Table :columns="columns2" :data="newList2" border style="margin-top:20px" @on-selection-change='selectionClick'/>
                        <Page 
                                :total="this.page.total"
                                :current="this.page.page"
                                :page-size="this.page.size"
...
import { volunteeradd, getvolunteername,gethealthList ,getenterList} from "../../../../api/volunteer";
  ...
  methods: {
    ...
    getList(){
       const enterlist={
                ...
                projectId:'1',
                physicalExaStatusL:'4',
                empName:this.health.name,
    }
    getenterList(enterlist).then(res=>{
        this.newList=res.data.page.list
        console.log(this.newList,'这是入组的列表')
      ...
      getList2(){
        // 脱落
           const masslist={
                ...
                pageSize:this.page.pageSize,
                projectId:'1',
                physicalExaStatusL:'6',
                empName:this.health.name,
    }
    getenterList(masslist).then(res=>{
        this.newList2=res.data.page.list
        // console.log(this.newList2,'这是脱落的列表')
