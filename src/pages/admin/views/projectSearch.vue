    ...
    <Card>
      <div style="min-height: 200px;">
        ...
        <Form inline :model="query" label-position="right" :label-width="80" class="query-form">
          <FormItem>
            <Input v-model="query.name" placeholder="请选择项目名称" style="width:150px;"></Input>
          </FormItem>
          <FormItem  :label-width="70">
            <Input v-model="query.des" placeholder="请选择机构" style="width:150px;"></Input>
          </FormItem>
           <FormItem  :label-width="70" style="margin-left:0px">
            <Input v-model="query.des" placeholder="请选择补偿金额" style="width:150px;" ></Input>
          </FormItem>
          <FormItem :label-width="50">
            <Button  type="primary" @click="handleSearch">查询</Button>
          </FormItem>
          <FormItem :label-width="30">
            <Button  type="primary" style="float:right;" @click="handleAdd()">新建</Button>
          </FormItem>
        </Form>
        <!-- 数据表格 -->
