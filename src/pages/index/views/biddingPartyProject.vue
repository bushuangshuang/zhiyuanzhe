    ...
    <div >
        ...
        <div class="bgColor">
            <div class="container list-title" style="padding:17px 15px 0px 15px;">
                <span style="color: #999999">当前位置：<a href="/biddingParty" style="color:#999999">申办方</a> > <a href="/biddingPartyDetail" style="color:#999999">查看项目</a> > </span> 项目详情
                <div class="searchRes-project" style="margin-top:20px;">
                    <div class="row " style="padding:0px 20px 0px 30px;">
                        ...
                        <div class="col-md-4 resCenter-project">
                            <h4 class="resCenter-title-project">胃癌或胃食管结合部腺癌患者招募</h4>
                        ...
                        <div class="col-md-4 resRight">
                            <button class="btn btn-default checkDetail">招募中</button>
                        </div>
                    </div>
                </div>
